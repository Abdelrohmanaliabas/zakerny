...
const List<DhikrReminderItem> defaultDhikrReminders = [
  ...
  DhikrReminderItem(
    ...
    rawSoundName: 'dhikr_hawqala',
  ),
  DhikrReminderItem(
    id: 'alhamdulillah',
    title: '🤲 الحمد لله رب العالمين',
    text:
        'الحَمْدُ للهِ رَبِّ العَالَمِينَ حَمْدًا كَثِيرًا طَيِّبًا مُبَارَكًا فِيهِ',
    ...
    rawSoundName: 'dhikr_alhamdulillah',
  ),
  DhikrReminderItem(
    id: 'subhanallah',
    title: '🌸 سبحان الله',
    ...
    rawSoundName: 'dhikr_subhanallah',
  ),
  DhikrReminderItem(
    id: 'baqiyat',
    title: '🌸 الباقيات الصالحات',
    text:
        'سُبْحَانَ اللهِ، وَالحَمْدُ للهِ، وَلَا إِلَهَ إِلَّا اللهُ، وَاللهُ أَكْبَرُ، وَلَا حَوْلَ وَلَا قُوَّةَ إِلَّا بِاللهِ العَلِيِّ العَظِيمِ',
    virtue:
        '«أَحَبُّ الكَلَامِ إِلَى اللهِ أَرْبَعٌ، وَهُنَّ البَاقِيَاتُ الصَّالِحَاتُ»',
    spokenPhrase: 'سبحان الله والحمد لله ولا إله إلا الله والله أكبر',
    audioAsset: 'assets/audio/dhikr/dhikr_baqiyat.mp3',
    rawSoundName: 'dhikr_baqiyat',
  ),
  DhikrReminderItem(
    id: 'sayyid_istighfar',
    title: '🤲 سيد الاستغفار',
    ...
    rawSoundName: 'dhikr_sayyid_istighfar',
  ),
  DhikrReminderItem(
    id: 'yunus',
    ...
    virtue:
        '«دَعْوَةُ ذِي النُّونِ لَمْ يَدْعُ بِهَا رَجُلٌ مُسْلِمٌ فِي شَيْءٍ قَطُّ إِلَّا اسْتَجَابَ اللَّهُ لَهُ»',
    spokenPhrase: 'لا إله إلا أنت سبحانك إني كنت من الظالمين',
    audioAsset: 'assets/audio/dhikr/dhikr_yunus.mp3',
    rawSoundName: 'dhikr_yunus',
  ),
  DhikrReminderItem(
    id: 'dua_rahma',
    title: '🤍 يا حي يا قيوم',
